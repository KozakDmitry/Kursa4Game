...
public class RoomPlacer : MonoBehaviour
{
    ...
    //    Room newRoom = Instantiate(RoomPrefabs[Random.Range(0, 10)]);


    //    int limit =  30;
    //    while (limit-->0)
    //    {
    //        Vector2Int position = vacantPlaces.ElementAt(Random.Range(0, 10));
    //        newRoom.RotateRamdomly();
           
    //        if(ConnectToSomething(newRoom, position))
    //        {
    //            newRoom.tranform.position = new Vector3(position.x - 5, 0, position.y - 5) * 12;
